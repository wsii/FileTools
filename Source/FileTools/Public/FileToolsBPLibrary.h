...
#include "FileToolsBPLibrary.generated.h"
...
*/
UCLASS()
class UFileToolsBPLibrary : public UBlueprintFunctionLibrary
{
...
public:
	...
	DECLARE_FUNCTION(execReadConfig)
	{
		...
		Success = UFileToolsBPLibrary::ReadConfigFile(FilePath, Section, Key, Property, ValuePtr, SingleLineArrayRead);
	}
	...
	DECLARE_FUNCTION(execWriteConfig)
	{
		...
		Success = UFileToolsBPLibrary::WriteConfigFile(FilePath, Section, Key, Property, ValuePtr, SingleLineArrayWrite);
	}
